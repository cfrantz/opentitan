 ...
 * The `signature` string was copied verbatim into this test.
 */
// clang-format on
static const char kGettysburgDigest[] =
    "1e6fd4030f9034cd775708a396c324ed420ec587eb3dd433e29f6ac08b8cc7ba";
static const char kGettysburgSignature[] =
    "cda24f37d4979cea1446c495af344af83d2047d13191b41003431a182bf2b74c365b08b78c"
    "57e3c3c11960fbc4a53fb63f61aecba3ddbda00059aebd08ad8f2c";
...
status_t ecdsa_sh256_digest_test(void) {
  owner_digest_t digest;
  ecdsa_sha256_digest(&digest, kGettysburgPrelude,
                      sizeof(kGettysburgPrelude) - 1);

  char buf[65];
  hexstr_encode(buf, sizeof(buf), &digest, sizeof(digest));
  LOG_INFO("digest = %s", buf);
  return OK_STATUS();
}
...
bool test_main(void) {
  ...
  EXECUTE_TEST(result, ecdsa_sh256_digest_test);
