...
rom_error_t owner_init(void) {
  ...
  dbg_printf("recovery_key = %p\r\n", kOwnershipNoOwnerRecoveryKey);
  ...
  result = owner_key_validate(/*page=*/0, kOwnershipKeyOwner,
...
hardened_bool_t owner_key_validate(size_t page, ownership_key_t key,
