...
#ifndef OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_ECDSA
#define OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_ECDSA
...
/**
 * Performs a SHA256 digest over a message.
 *
 * @param digest Array where the digest will be written.
...
#endif  // OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_ECDSA
