...
_NORMAL_DEPENDENCIES = {
    "third_party/rust": {
        _COMMON_CONDITION: {
            ...
            "reqwest": "@crate_index__reqwest-0.12.9//:reqwest",
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crate_index__hyper-1.1.0",
        sha256 = "fb5aa53871fc917b1a9ed87b683a5d86db645e23acb32c2e0785a353e522fb75",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/hyper/1.1.0/download"],
        strip_prefix = "hyper-1.1.0",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.hyper-1.1.0.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__hyper-rustls-0.27.4",
        sha256 = "f6884a48c6826ec44f524c7456b163cebe9e55a18d7b5e307cb4f100371cc767",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/hyper-rustls/0.27.4/download"],
        strip_prefix = "hyper-rustls-0.27.4",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.hyper-rustls-0.27.4.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__hyper-util-0.1.3",
        sha256 = "ca38ef113da30126bbff9cd1705f9273e15d45498615d138b0c20279ac7a76aa",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/hyper-util/0.1.3/download"],
        strip_prefix = "hyper-util-0.1.3",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.hyper-util-0.1.3.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__libc-0.2.168",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.libc-0.2.168.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__pin-project-1.1.7",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.pin-project-1.1.7.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__pin-project-internal-1.1.7",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.pin-project-internal-1.1.7.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__pin-project-lite-0.2.15",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.pin-project-lite-0.2.15.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__reqwest-0.12.9",
        sha256 = "a77c62af46e79de0a562e1a9849205ffcb7fc1238876e9bd743357570e04046f",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/reqwest/0.12.9/download"],
        strip_prefix = "reqwest-0.12.9",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.reqwest-0.12.9.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__rustls-0.23.20",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.rustls-0.23.20.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__security-framework-sys-2.13.0",
        sha256 = "1863fd3768cd83c56a7f60faa4dc0d403f1b6df0a38c3c25f44b7894e45370d5",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/security-framework-sys/2.13.0/download"],
        strip_prefix = "security-framework-sys-2.13.0",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.security-framework-sys-2.13.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__tokio-1.42.0",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.tokio-1.42.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.tower-0.4.13.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__wasm-bindgen-0.2.99",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.wasm-bindgen-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__wasm-bindgen-backend-0.2.99",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.wasm-bindgen-backend-0.2.99.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__wasm-bindgen-macro-0.2.99",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.wasm-bindgen-macro-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__wasm-bindgen-macro-support-0.2.99",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.wasm-bindgen-macro-support-0.2.99.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__wasm-bindgen-shared-0.2.99",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.wasm-bindgen-shared-0.2.99.bazel"),
    )
