...
00000010: 45 43 44 53 00 00 00 00 00 00 00 00 00 00 00 00  ECDS............\n\
...
000000e0: 41 50 50 4b 70 00 00 00 45 43 44 53 70 72 6f 64  APPKp...ECDSprod\n\
  ...
  seal: "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
    ...
    fn test_owner_write() -> Result<()> {
        let own = OwnerBlock {
            version: 0,
            sram_exec: SramExecMode::default(),
            ownership_key_alg: OwnershipKeyAlg::Ecdsa,
