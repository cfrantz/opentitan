...
use crate::chip::boot_svc::{OwnershipUnlockRequest, OwnershipActivateRequest, UnlockMode};
...
impl OwnershipActivateParams {
    ...
    /// Reads an activate request (or creates a default request) and applies the aprameters.
