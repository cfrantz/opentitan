                                   ...
                                   const uint8_t *sk)
{
  ...
  //dbg_printf("t0=%d cp=%d, mat=%d\n", sizeof(t0), sizeof(cp), sizeof(mat));
  //dbg_printf("Compute mu @ %x\r\n", depth());
...
rej:
  //dbg_printf("Sample y\r\n");
  check_nested(__LINE__);
  /* Sample intermediate vector y */
  polyvecl_uniform_gamma1(&y, rhoprime, nonce++);

  /* Matrix-vector multiplication */
  //dbg_printf("Matrix-vec mult\r\n");
  z = y;
  polyvecl_ntt(&z);
  ...
  shake256_inc_ctx_release(&state);
  //dbg_printf("challenge\r\n");
  poly_challenge(&cp, sig);
  //dbg_printf("ntt\r\n");
  poly_ntt(&cp);

  /* Compute z, reject if it reveals secret */
  //dbg_printf("Compute z\r\n");
  check_nested(__LINE__);
